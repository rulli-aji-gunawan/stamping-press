function openForm() {
  ...
  document.getElementById("tbl-master-data-process-name").style.opacity = 0.2;
}

function closePopup() {
  document.getElementById("addForm").style.display = "none";
  document.getElementById("btn-addMasterData").style.opacity = 1;
  document.getElementById("tbl-master-data-process-name").style.opacity = 1;
}
...
function toProperCase() {
  ...
  document.getElementById("process_name").value = properCase(processName);
}

document.addEventListener('DOMContentLoaded', function () {
  const form = document.getElementById('addProcessNameForm');
